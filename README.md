...
│                                                                  │
│  Ingestion Pipeline                                              │
│   PDF/TXT bytes  →  PyPDF extract  →  RecursiveTextSplitter     │
│   →  HuggingFace Embeddings  →  MongoDB Atlas Vector Store      │
│                                                                  │
│  Query Pipeline                                                  │
│   User query  →  Embed query  →  Atlas Vector Search            │
│   →  Guardrailed Prompt  →  Groq LLM  →  JSON response          │
└─────────────────────────────────────────────────────────────────┘
```
